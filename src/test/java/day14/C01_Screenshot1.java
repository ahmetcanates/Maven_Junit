...
Selenium tum ekran goruntusu nasil alinir?
    -tum ekran goruntusu seleniumdan gelen getScreenshotAs metodu ile alinir.
 ...
 */
    ...
    public void fullPageScreenshotTest() throws IOException {
        ...
        //1. Ekran goruntusunu getScreenshotAs metodu ile alip File olarak olusturalim
...
//                new File(System.getProperty("user.dir")+"/test-output/EkranGoruntuleri/image.png"));//path
        ...
        //REUSABLE METHOD OLUSTURUP GORUNTUYU ALALIM
